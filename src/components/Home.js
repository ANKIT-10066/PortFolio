...
const Home = () => {
  ...
  return (
    <div>
      <section
        id="home"
        className="p-5 mx-20 mb-10 font-medium font-poppins max-sm:p-2 max-sm:mx-5 flex flex-col md:flex-row md:flex-wrap  items-center"
      >
          ...
          <div className="INTRO">
            ...
            <div className="my-8 flex items-center gap-5">
              <a
                href={Data.github}
                target="_blank"
                className="transition-all  text-gray-900 dark:text-white hover:scale-125 duration-300"
              >
                <BsGithub size={30} />
              </a>
              <a
        ...
        <div className=" md:w-1/2 flex justify-center mt-5 md:mt-0 relative button-animation">
          <Lottie
            animationData={computer}
            loop={true}
            className="max-w-[650px] md:max-w-[800px] rounded-xl border dark:border-[#00040f]"
          />
        </div>
      </section>
      </div>
